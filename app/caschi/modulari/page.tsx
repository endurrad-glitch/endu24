export default function CaschiModulari() {

  const products = [
    { name: "Shoei Neotec 2", slug: "casco-shoei-neotec-2", price: 599 },
    { name: "AGV Sportmodular", slug: "casco-agv-sportmodular", price: 499 }
  ];
